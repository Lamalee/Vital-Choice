...
<html lang="vi">
  ...
  <body class = "teacher-page">
    <header>
     <a class="headerVT" href="#home"> <h1>Vital Choice</h1></a>
      <nav>
        <ul>
          <li><a href="../vital_wiki/wiki.php">Vital WiKi</a></li>
    ...
    <main>
      <section id="home">
        <h2 class="welcome">Welcome RESPECT TEACHER, <?php echo $_SESSION['username']; ?>!</h2>
        <h2 class="welcome"> <u>CONTROL</u> the <u>GAME</u>, <u>SHAPE</u> their <u>LIVES</u>!!!</h2>
       <form action="thuviengiaovien.php" method="POST"> 
        <div class="divPlay">
        <div>
    <button type="submit">LIBRARY TEACHER</button>
</div>
</div>
</form>
      </section>

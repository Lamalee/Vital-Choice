...
<html lang="vi">
  ...
  <body>
      ...
      document.addEventListener('DOMContentLoaded', function() {
        <?php
          if (isset($_SESSION['error_message'])) {
            echo "showErrorModal('" . addslashes($_SESSION['error_message']) . "');";
    ...
    <h2 class="welcome">
    Welcome, 
    <a href="../profile/profile.php" title="Ấn vào để vào profile">
        <?php echo $_SESSION['username']; ?>
    </a>
</h2>
        <h2 class="welcome">Your <u>CHOICE</u> for your <u>LIFE</u>!!!</h2>
       <form action="../api/startgame.php" method="POST"> 
        <div class="divPlay">
          <div class="exam-code-container">
                <input type="text" name="exam_code" placeholder="Nhập mã đề (nếu có)">
            </div>
        <div>
